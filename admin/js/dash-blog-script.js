/* =============================================
   ...
   Blog & News: list, add, edit, delete, view.
   Same pattern as dash-actualite-script.js
   Only differences: API endpoints (/blog),
   categories, demo data, and labels.
============================================= */
...
/* =============================================
   ...
   [
     {
       id:         1,
       title_en:   "Sustainable Mining Practices in Central Africa",
       title_fr:   "Pratiques Minières Durables en Afrique Centrale",
...
function loadItems() {
  ...
  apiGet('/blog').then(function(data) {
    ...
    STATE.items = [
      { id:1, title_en:'Sustainable Mining Practices in Central Africa', title_fr:'Pratiques Minières Durables en Afrique Centrale', category:'sustainability', status:'published', icon:'ph-recycle',    text_en:'Lorem ipsum dolor sit amet consectetur adipiscing elit. Sustainable mining is becoming a critical focus for operations across Central Africa as environmental standards tighten.', text_fr:'Lorem ipsum dolor sit amet consectetur adipiscing elit. L\'exploitation minière durable devient un enjeu crucial en Afrique Centrale.', created_at:'2025-01-08' },
      { id:2, title_en:'ITIE Report 2024: Key Challenges for Cameroon', title_fr:'Rapport ITIE 2024: Défis Clés pour le Cameroun',   category:'analysis',       status:'published', icon:'ph-chart-bar',  text_en:'Lorem ipsum dolor sit amet consectetur adipiscing elit. The 2024 ITIE report highlights major transparency and governance challenges in the Cameroonian mining sector.', text_fr:'Lorem ipsum dolor sit amet consectetur adipiscing elit. Le rapport ITIE 2024 souligne les principaux défis de gouvernance.', created_at:'2025-01-22' },
      { id:3, title_en:'Digital Innovation in Mine Water Treatment',     title_fr:'Innovation Numérique dans le Traitement des Eaux', category:'technology',    status:'published', icon:'ph-cpu',        text_en:'Lorem ipsum dolor sit amet consectetur adipiscing elit. New digital monitoring technologies are transforming how mining operations manage water quality.', text_fr:'Lorem ipsum dolor sit amet consectetur adipiscing elit. Les nouvelles technologies numériques transforment la gestion de l\'eau dans les mines.', created_at:'2025-02-05' },
      { id:4, title_en:'ARD Prevention: Best Practices for 2025',       title_fr:'Prévention de l\'ARD: Meilleures Pratiques 2025', category:'environment',   status:'published', icon:'ph-leaf',        text_en:'Lorem ipsum dolor sit amet consectetur adipiscing elit. Acid Rock Drainage prevention remains one of the most important environmental challenges in mining operations.', text_fr:'Lorem ipsum dolor sit amet consectetur adipiscing elit. La prévention du DRA reste l\'un des défis environnementaux les plus importants.', created_at:'2025-02-18' },
      { id:5, title_en:'Interview: The Future of Open-Pit Mining',       title_fr:'Interview: L\'Avenir des Mines à Ciel Ouvert',    category:'interview',     status:'draft',     icon:'ph-microphone', text_en:'Lorem ipsum dolor sit amet consectetur adipiscing elit. We sat down with leading mining engineers to discuss the future direction of open-pit operations.', text_fr:'Lorem ipsum dolor sit amet consectetur adipiscing elit. Nous avons rencontré des ingénieurs miniers pour discuter de l\'avenir des mines à ciel ouvert.', created_at:'2025-03-10' },
      { id:6, title_en:'Cameroon\'s Mining Sector: 2025 Outlook',        title_fr:'Le Secteur Minier du Cameroun: Perspectives 2025', category:'mining',       status:'published', icon:'ph-mountains',  text_en:'Lorem ipsum dolor sit amet consectetur adipiscing elit. A comprehensive look at the opportunities and challenges facing Cameroon\'s mining industry this year.', text_fr:'Lorem ipsum dolor sit amet consectetur adipiscing elit. Un regard complet sur les opportunités et défis du secteur minier camerounais.', created_at:'2025-03-25' }
    ];
    applyFilters();
  });
}
...
function renderGrid() {
  ...
  if (page.length === 0) {
    grid.innerHTML = '<div class="posts-empty"><i class="ph ph-magnifying-glass" style="font-size:3rem;color:var(--gray-light);"></i><h3>'+(lang==='fr'?'Aucun article trouvé':'No posts found')+'</h3><p>'+(lang==='fr'?'Modifiez vos filtres.':'Try adjusting your filters.')+'</p></div>';
    return;
  }
...
document.getElementById('confirm-delete-btn').addEventListener('click', function() {
  ...
  */
  ...
  function afterDel() {
    ...
    showToast('success', lang==='fr'?'Article supprimé':'Post deleted', '"'+STATE.deletingName+'" '+(lang==='fr'?'supprimé.':'removed.'));
...
/* ── FORM SUBMIT ──
   ADD:  POST /blog           → returns saved object
   EDIT: PUT  /blog/{id}      → returns updated object
...
document.getElementById('submit-form').addEventListener('click', function() {
  ...
  var endpoint = isEdit ? '/blog/'+STATE.editingId : '/blog';
  ...
  function afterSave(data) {
    ...
    showToast('success', isEdit?(lang==='fr'?'Article mis à jour':'Post updated'):(lang==='fr'?'Article ajouté':'Post added'), '"'+payload.title_en+'" '+(lang==='fr'?'enregistré.':'saved.'));
    btn.disabled = false;
